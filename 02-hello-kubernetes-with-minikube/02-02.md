...
An _Ingress Controller_ is a reverse proxy that watches for _Ingress Resources_ in the _Kubernetes_ API server and configures itself with appropriate rules as per the _Ingress_.
